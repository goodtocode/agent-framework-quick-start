...
namespace Goodtocode.AgentFramework.Presentation.Web.Pages.Chat.Models
{
    public class ChatSessionTreeViewItem(ChatSessionModel session) : ITreeViewItem
    {
        public ChatSessionModel Session { get; } = session;
