...
namespace Goodtocode.AgentFramework.Presentation.WebApi;
...
public static class ConfigureServices
{
    ...
    public class ConfigureSwaggerOptions(IApiVersionDescriptionProvider provider) : IConfigureNamedOptions<SwaggerGenOptions>
    {
        ...
        private static OpenApiInfo CreateVersionInfo(ApiVersionDescription description)
        {
            ...
            {
                Title = $"Agent Framework Service ({Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT")})",
                Version = description.ApiVersion.ToString(),
                Description = $"An API to interact with the Agent Framework",
