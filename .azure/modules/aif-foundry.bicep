...
@description('Required list of model deployments. Each object deploys one model. Allowed modelName values: claude-opus, claude-sonnet, gpt-5.4, gpt-5.4, gpt-5.4-mini, phi-4, mai-code, mai-image-2.5, mai-image-2.5-flash, mai-image-2.5-pro.')
@minLength(1)
